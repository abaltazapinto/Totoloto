...
const generateTotoButton = document.getElementById('generateTotoButton')
...
generateTotoButton.addEventListener("click", () => generateNumbers('totolotoNumbers', 6, () => generateStars('totolotoNumbers'))); 
